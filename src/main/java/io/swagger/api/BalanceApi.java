...
public interface BalanceApi {
    ...
    @ApiOperation(value = "", nickname = "getBalance", notes = "Returns a current balance.", response = Balance.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Current balance.", response = Balance.class),
