...
@Api(value = "health-check", description = "the health-check API")
@RequestMapping(value = "")
public interface HealthCheckApi {

    @ApiOperation(value = "", nickname = "healthCheck", notes = "Returns 200 if service works okay.", response = Object.class, responseContainer = "Map", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Extra details about service status, if any.", response = Map.class, responseContainer = "Map"),
